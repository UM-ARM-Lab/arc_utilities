...
int main(int argc, char* argv[])
{
    ...
    const Vector3d weighted_average = AverageEigenVector3d(test_vectors, weights);
    ...
    const Vector3d repeated_average = AverageEigenVector3d(repeated_test_vectors);
    ...
    const Vector3d weighted_average_all_zero_weights = AverageEigenVector3d(test_vectors, all_zero_weights);
