...
class SimpleRRTPlannerState {
 ...
 public:
  ...
  uint64_t SerializeSelf(std::vector<uint8_t>& buffer,
    ...
    arm_utilities::SerializeFixedSizePOD<int64_t>(parent_index_, buffer);
    // Serialize the child indices
    arm_utilities::SerializeVector<int64_t>(child_indices_, buffer, arm_utilities::SerializeFixedSizePOD<int64_t>);
    // Serialize the value
  ...
  uint64_t DeserializeSelf(
    ...
    const std::pair<std::vector<int64_t>, uint64_t> child_indices_deserialized =
        arm_utilities::DeserializeVector<int64_t>(buffer, current_position,
                                                  arm_utilities::DeserializeFixedSizePOD<int64_t>);
