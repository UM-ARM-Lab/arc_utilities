...
namespace PrettyPrint
{
    ...
    template<>
    inline std::string PrettyPrint(const EigenHelpers::Vector3d& vector_to_print, const bool add_delimiters, const std::string& separator);
    ...
    inline std::string PrettyPrint(const Eigen::Affine3d& transform_to_print, const bool add_delimiters, const std::string& separator)
    {
        UNUSED(add_delimiters);
        UNUSED(separator);
        EigenHelpers::Vector3d vector_to_print = transform_to_print.translation();
